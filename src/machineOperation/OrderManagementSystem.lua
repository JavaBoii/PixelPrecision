...
clearScreen()
print("OrderManagementSystem running...")

MONITOR.setTextScale(0.5)  -- Set text scale to 0.5

printToMonitor("OrderManagementSystem online. Waiting for orders on ch 1.")
MODEM.transmit(101, 101, "OrderManagementSystem")  -- Send online status
